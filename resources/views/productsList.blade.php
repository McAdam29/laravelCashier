...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card" >
                <div class="card-header">Products List Screen</div>

                <div class="card-body">
                    <div id="fdw-pricing-table">
                        @foreach ($productList as $list)
                            <div class="plan plan1" style="width: 47%;">
                            <div class="header">{{$list['product_name']}}</div>
                            <div class="price">{{$list['price']}}</div>
                            <ul>
                                <li class="monthly"> Code : {{$list['product_id']}}</li>
                            </ul>
                            <a class="signup" href="{{route('buyNow', $list)}}">Buy Now</a>
                        </div>
                        @endforeach
                    </div>
